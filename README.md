...
### {.is-success} Python, Pandas, Matplotlib, Plotly, Seaborn, Tableau, SQL, PostgreSQL, построение дашбордов, исследовательский анализ, предобработка данных, когортный анализ, юнит-экономика.
